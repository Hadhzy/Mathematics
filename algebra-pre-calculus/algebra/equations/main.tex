...
\begin{align*}
    \includegraphics[width=1.1\textwidth]{algebra-pre-calculus/algebra/equations/properties_of_equations.png}
\end{align*}
...
\begin{align*}
    \includegraphics[width=1.1\textwidth]{algebra-pre-calculus/algebra/equations/discriminant.png}
\end{align*}
...
\begin{align*}
    \includegraphics[width=1.1\textwidth]{algebra-pre-calculus/algebra/equations/completing_square.png}
\end{align*}
