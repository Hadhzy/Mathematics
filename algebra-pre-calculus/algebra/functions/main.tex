...
\begin{align*}
	\includegraphics{algebra-pre-calculus/algebra/functions/graph1.png}
\end{align*}
\vspace{1pt}
What is $g(2)$ ? $ g(5) ?$ \\
...
\begin{align*}
	\includegraphics{algebra-pre-calculus/algebra/functions/graph2.png}
\end{align*}
...
\begin{align*}
	\includegraphics{algebra-pre-calculus/algebra/functions/graph3.png}
\end{align*}
...
\begin{align*}
	\includegraphics{algebra-pre-calculus/algebra/functions/graph4.png}
\end{align*}
...
\begin{align*}\includegraphics{algebra-pre-calculus/algebra/functions/graph5.png}\end{align*}
...
\begin{align*}\includegraphics{algebra-pre-calculus/algebra/functions/graph6.png}\end{align*}
...
\begin{align*}
	\includegraphics{algebra-pre-calculus/algebra/functions/example_graph.png}
\end{align*}
...
\begin{align*}
	\includegraphics{algebra-pre-calculus/algebra/functions/even_odd_graph1.png} \\
\end{align*}
...
\begin{align*}
	\includegraphics{algebra-pre-calculus/algebra/functions/even_odd_graph2.png} \\
\end{align*}
...
\begin{align*}
	\includegraphics{algebra-pre-calculus/algebra/functions/even_odd_graph3.png} \\
\end{align*}
...
\begin{align*}
\includegraphics[width=1.2\textwidth]{algebra-pre-calculus/algebra/functions/even_odd_example1.png}
\end{align*}
...
see here: 
\begin{align*}
	\includegraphics{algebra-pre-calculus/algebra/functions/even_odd_example2.png} \\
\end{align*}
...
see here:
\begin{align*}
	\includegraphics{algebra-pre-calculus/algebra/functions/even_odd_example3.png} \\
\end{align*}
...
\begin{align*}
	\includegraphics[width=1.1\textwidth]{algebra-pre-calculus/algebra/functions/toolkit_functions.png}
\end{align*}
