...
\begin{align*}
    \includegraphics[width=1.1\textwidth]{algebra-pre-calculus/complex-numbers/dividing_complex_numbers.png}
\end{align*}
...
\begin{align*}
    \includegraphics[width=1.1\textwidth]{algebra-pre-calculus/complex-numbers/square_roots_of_negative_numbers.png}
\end{align*}
